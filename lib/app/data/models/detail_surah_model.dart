...
DetailSurahModel detailSurahModelFromJson(String str) =>
    DetailSurahModel.fromJson(json.decode(str));

String detailSurahModelToJson(DetailSurahModel data) =>
...
class DetailSurahModel {
  ...
  factory DetailSurahModel.fromJson(Map<String, dynamic>? json) =>
      DetailSurahModel(
        ...
        tafsir: DetailSurahModelTafsir.fromJson(json?["tafsir"]),
...
class DetailSurahModelTafsir {
  String? id;

  DetailSurahModelTafsir({
    this.id,
  });

  factory DetailSurahModelTafsir.fromJson(Map<String, dynamic>? json) =>
      DetailSurahModelTafsir(
        id: json?["id"],
      );
